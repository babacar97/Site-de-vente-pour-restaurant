...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Helpers:bootstrap_popup.html.twig", "C:\\xampp\\htdocs\\prestashop_1.7.7.6\\src\\PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
